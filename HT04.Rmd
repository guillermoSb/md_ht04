...
```
El RMSE para el modelo 1 es `r rmse_model_1` y el error absoluto es `r abs_error_1`. Tomando en cuenta los valores reales y los que se predijeron se sabe que en promedio hubo un error en promedio de USD `r mean_error_8`.
