...
data$economy <- ifelse(data$salePrice < 150000, "Económicas", ifelse(data$salePrice >= 150000 & data$salePrice <= 400000, "Intermedias", "Caras"))
```
...
```{r}
arbol_modelo <- rpart(economy~., data, method="class")
