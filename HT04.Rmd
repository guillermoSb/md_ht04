...
```{r}
test_set$housePriceCategory <- ifelse(test_set$salePrice < 163000, "Economic", ifelse(test_set$salePrice >= 163000 & test_set$salePrice <= 214000, "Average", "Expensive"))

train_set$housePriceCategory <- ifelse(train_set$salePrice < 163000, "Economic", ifelse(train_set$salePrice >= 163000 & train_set$salePrice <= 214000, "Average", "Expensive"))
```
...
## 7 - Arbol de clasificación utilizando la variable respuesta
